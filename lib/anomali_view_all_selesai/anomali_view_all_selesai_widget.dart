...
class AnomaliViewAllSelesaiWidget extends StatefulWidget {
  const AnomaliViewAllSelesaiWidget({Key key}) : super(key: key);

  @override
  _AnomaliViewAllSelesaiWidgetState createState() =>
      _AnomaliViewAllSelesaiWidgetState();
}

class _AnomaliViewAllSelesaiWidgetState
    extends State<AnomaliViewAllSelesaiWidget> {
