...
import '../components/qrcode_view_widget.dart';
                                ...
                                FlutterFlowIconButton(
                                  ...
                                  onPressed: () async {
                                    ...
                                    final anomaliUpdateData =
                                      ...
                                      qrCodeAnomali: _currentPageLink,
                                    );
                                    await anomaliDetailAnomaliRecord.reference
                                        ...
                                        Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  20, 0, 20, 0),
                                          child: Text(
                                            'MCB PMT PHT Paya Geli - Glugur 1 jatuh pada saat pemulihan yang menyebabkan PMT tidak bisa charging.',
                                        ...
                                        children: [
                                          Align(
                                            alignment:
                                                AlignmentDirectional(0, 0),
                                            child: Text(
                                              'Belum ada penyelesaian untuk anomali ini.',
                                              style: FlutterFlowTheme.of(
                                                      context)
                                                  .bodyText1
                                                  .override(
                                          ...
                                          Align(
                                            ...
                                            child: Padding(
                                              padding: EdgeInsetsDirectional
                                                  .fromSTEB(0, 0, 0, 15),
                                              child: Text(
                                                'Belum ada diskusi untuk anomali ini.',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyText1
                                                        .override(
